...
除非页面另有说明，本仓库中的生成性 wiki 说明文字、导航结构和 HTML 文档内容，按 Creative Commons Attribution 4.0 International License (CC BY 4.0) 发布。

Unless otherwise noted, the generated wiki prose, navigation structure, and HTML documentation content in this repository are licensed under the Creative Commons Attribution 4.0 International License (CC BY 4.0).

你可以在符合 CC BY 4.0 要求的前提下分享和改编这些生成文档内容，包括保留适当署名并标明修改。
...
Pagefind assets included in this repository remain under the Pagefind MIT License; see `UPSTREAM-LICENSES/Pagefind-LICENSE.txt`.
